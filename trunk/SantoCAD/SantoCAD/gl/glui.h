...
private:
	...
	float angleRadiansX;
	float angleRadiansY;
	void GLUI_Rotation::calcolateAngleRadiansX();
	void GLUI_Rotation::calcolateAngleRadiansY();
public:
    Arcball        *ball;
	...
	//MOD
	void GLUI_Rotation::setConstraintX(bool b);
	void GLUI_Rotation::setConstraintY(bool b);
	void GLUI_Rotation::setAngleY(float f);
	float GLUI_Rotation::getAngleY();
	float GLUI_Rotation::getAngleRadiansY();
	void GLUI_Rotation::setAngleX(float f);
	float GLUI_Rotation::getAngleX();
	float GLUI_Rotation::getAngleRadiansX();
